...
public class confirm_fund_transfer_rgts extends AppCompatActivity {
    ...
    EditText mpin;
    Button cont;
    String Sbi_REQUEST_URL="http://52.172.213.166:8080/sbi/RTGS/api/TxnRTGS";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_confirm_fund_transfer_rgts);
        setupActionbar();
        from_acc_no=(TextView) findViewById(R.id.confirm_fund_transfer_rgts_from_acc_no);

        from_name=(TextView)findViewById(R.id.confirm_fund_transfer_rgts_from_name);
        to_name=(TextView)findViewById(R.id.confirm_fund_transfer_rgts_to_name);
        to_acc_no=(TextView)findViewById(R.id.confirm_fund_transfer_rgts_to_acc_no);
        amount=(TextView)findViewById(R.id.confirm_fund_transfer_rgts_amount);
        from_ifsc=(TextView)findViewById(R.id.confirm_fund_transfer_rgts_from_ifsc);
        to_ifsc=(TextView)findViewById(R.id.confirm_fund_transfer_rgts_to_ifsc);
        mob_no=(TextView)findViewById(R.id.confirm_fund_transfer_rgts_from_mob);
        ...
        cont=(Button)findViewById(R.id.confirm_fund_transfer_rgts_submit);

        cont.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                confirm_fund_transfer_rgts.AccountAsync task=new confirm_fund_transfer_rgts.AccountAsync();
                task.execute();
            }
        });
    }
    private void setupActionbar(){
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(confirm_fund_transfer_rgts.this,HomeActivity.class);
    ...
    public class AccountAsync extends AsyncTask<URL,Void,String> {
        ...
        ProgressDialog progressDialog=new ProgressDialog(confirm_fund_transfer_rgts.this);
        @Override
        ...
        protected void onPostExecute(String account) {
            ...
            if(account==null||!account.contains("SUCCESS")){
                Toast.makeText(confirm_fund_transfer_rgts.this,"Invalid Credencials",Toast.LENGTH_SHORT).show();
           progressDialog.dismiss();
                return;
            }

            Toast.makeText(confirm_fund_transfer_rgts.this,account,Toast.LENGTH_SHORT).show();
            Intent intent=new Intent(confirm_fund_transfer_rgts.this,transaction_status.class);
