...
public class customer_locker_enquiry extends AppCompatActivity {
    ArrayList<Account_layout> accounts;
    Account_layout customer;
    String Sbi_REQUEST_URL="http://52.172.213.166:8080/sbi/Locker/customerLocker/enquiry";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_customer_locker_enquiry);
   ...
   customer_locker_enquiry.AccountAsync task=new customer_locker_enquiry.AccountAsync();
   task.execute();
    }
    private void setupActionbar(){
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(customer_locker_enquiry.this,HomeActivity.class);
    ...
    public class AccountAsync extends AsyncTask<URL,Void,String> {
        ...
        ProgressDialog progressDialog=new ProgressDialog(customer_locker_enquiry.this);
        @Override
        ...
        protected void onPostExecute(String account) {
            ...
            if(pro==null){
                Toast.makeText(customer_locker_enquiry.this,"Invalid Credencials",Toast.LENGTH_SHORT).show();
          progressDialog.dismiss();
                return;
            }

            Toast.makeText(customer_locker_enquiry.this,pro,Toast.LENGTH_SHORT).show();
    ...
    public String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            jsonObject.put("CUSTOMER_NO",customer.getCustomerNumber());
    ...
    public String extractBankAccount(String json) {
        ...
        try {
            ...
            type=object.getString("LOCKER_ACCOUNT_NO");
