...
public class fund_transfer_rgts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fund_transfer_rgts);
        setupActionbar();
        ...
        from_acc_no=(Spinner)findViewById(R.id.fund_transfer_rgts_from_acc_no);

        from_name=(EditText)findViewById(R.id.fund_transfer_rgts_from_name);
        to_name=(EditText)findViewById(R.id.fund_transfer_rgts_to_name);
        to_acc_no=(EditText)findViewById(R.id.fund_transfer_rgts_to_acc_no);
        amount=(EditText)findViewById(R.id.fund_transfer_rgts_amount);
        from_ifsc=(EditText)findViewById(R.id.fund_transfer_rgts_from_ifsc);
        to_ifsc=(EditText)findViewById(R.id.fund_transfer_rgts_to_ifsc);
        mob_no=(EditText)findViewById(R.id.fund_transfer_rgts_from_mob);

        cont=(Button)findViewById(R.id.fund_transfer_rgts_submit);
        ...
        cont.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(fund_transfer_rgts.this,confirm_fund_transfer_rgts.class);
    ...
    private void setupActionbar(){
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(fund_transfer_rgts.this,HomeActivity.class);
                startActivity(intent);
                finish();
            }
        });
